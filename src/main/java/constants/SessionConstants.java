...
public class SessionConstants {
    ...
    public static final String CASSANDRA_TRUSTSTORE_PATH = "persistence.cassandra.truststore_path";
    public static final String CASSANDRA_TRUSTSTORE_CRED = "persistence.cassandra.truststore_pwd";
    public static final String CASSANDRA_KEYSTORE_PATH = "persistence.cassandra.keystore_path";
    public static final String CASSANDRA_KEYSTORE_CRED = "persistence.cassandra.keystore_pwd";
